    ...
    <footer className="w-full bg-[#111]">
        <div className="flex text-cinza">
            <div className="esquerda basis-1/2 py-2.5 px-5">
                ...
                <div className="relative mx-auto align-center py-0 px-5 mt-5 before:absolute before:content-[''] before:w-full before:bg-[#1a1a1a] before:h-0.5 before:top-[-10px] after:absolute after:content-[''] after:w-1/5 after:bg-[#020fff] after:h-0.5 after:top-[-10px]">
                    <form action="#">
