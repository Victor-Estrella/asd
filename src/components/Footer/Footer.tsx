      ...
      <div className="flex text-cinza">
        <div className="basis-1/2 py-2 px-4">
          ...
          <div className="box relative mx-auto py-2 px-4 mt-4">
            <form action="#">
              <div className="mt-4">
                <div className="font-semibold text-[#4e4e4e] pb-1.5 text-xl">Nome</div>
                <input className="w-full pl-2 text-lg text-[#b9b9b9] bg-[#151515] border-[#222222] border-2 h-8" type="text" required />
              </div>
              <div className="mt-4">
                <div className="font-semibold text-[#4e4e4e] pb-1.5 text-xl">E-mail</div>
                <input className="w-full pl-2 text-lg text-[#b9b9b9] bg-[#151515] border-2 border-[#222222] h-8" type="email" required />
              </div>
              <div className="mt-4">
                <div className="font-semibold text-[#4e4e4e] pb-1.5 text-xl">Mensagem (explique seu problema)</div>
        ...
        <div className="basis-1/2 py-2 px-4">
          ...
          <div className="box relative mx-auto py-2 px-4 mt-4">
            <div className="mt-4">
              <span className="font-semibold text-[#7a7a7a] text-base">R EMILIA MARENGO, 451 - VILA REGENTE FEIJO - SAO PAULO</span>
            </div>
            <div className="mt-2">
              <span className="font-semibold text-[#7a7a7a] text-base">+333 76786</span>
            </div>
            <div className="mt-2">
              <span className="font-semibold text-[#7a7a7a] text-base">prevencao.cartoes@portoseguro.com.br</span>
            </div>
            <div className="mt-4 flex justify-evenly">
              <img className="w-40" src={LogoPorto} alt="Logo Porto Seguro" />
              <img className="w-40" src={LogoFiap} alt="Logo FIAP" />
            </div>
          </div>
        </div>
      </div>
