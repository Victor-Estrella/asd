        ...
        <div className="overlay-container hidden lg:block">
            <div className="overlay bg-azulclaro bg-no-repeat bg-cover bg-[0_0] text-branco relative -left-full h-full w-[200%]">
                <div className="overlay-panel overlay-left">
                    ...
                    <button
                        className="mt-10 rounded-full border border-white bg-transparent text-white text-2xl font-bold my-2 px-20 py-3 tracking-wide capitalize transition duration-300 ease-in-out hover:tracking-wider active:scale-95 focus:outline-none"
